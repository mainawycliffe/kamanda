...
var rootCmd = &cobra.Command{
	Use:   "firebase-cli",
	Short: "A companion tool for Firebase Tools",
	Long: `This cli tool is mean as a companion tool for Firebase CLI Tool 
  and should be used alongside it.
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".firebase-cli" (without extension).
